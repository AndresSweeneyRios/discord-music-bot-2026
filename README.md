...
This is a lightweight, minimalist music bot for Discord. It only supports one channel at a time across all guilds as it is intended for personal use, but future pull requests may absolutely expand the feature set. Seeking is also not supported.
